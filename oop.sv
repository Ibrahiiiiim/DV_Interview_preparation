...
//Encapsulation in SystemVerilog allows us to bundle properties and methods together 
//while restricting access using protected or local keywords.
// This prevents accidental modifications and enforces controlled access.
  class transaction;
...
// 	•	virtual is required when we want to override a base class function in a derived class while 
//ensuring that the function in the base class can still be accessed dynamically.
...
// Registering a class to the UVM factory allows UVM to dynamically create objects at runtime. 
//This is essential for object replacement, reusability, and factory pattern-based overrides.
